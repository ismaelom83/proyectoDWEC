...
<html lang="en">
    ...
    <body>
        ...
        <main>       
                ...
                <div class="card-deck ">
                    <div class="card card1">
                        <a href="ventanasFrames/index.html"><img src="../../../images/js.png" class="card-img-top card-fluid" alt="..."></a>
                        <div class="card-body">
                            <a href="ventanasFrames/index.html" class="text-decoration-none"> <h5 class="card-title">Ventanas y Frames practica 20</h5></a>
                            <a href="ventanasFrames/index.html" class="text-decoration-none"><p class="card-text">Ejercicio para ptacticar el manejo de ventanas y mensajes entre ventanas del DOM.</p></a>
                        </div>
                    </div>                   
                     <div class="card card1">
                         <a href="WINDOW/window.html"><img src="../../../images/js.png" class="card-img-top card-fluid" alt="..."></a>
                        <div class="card-body">
                            <a href="WINDOW/window.html" class="text-decoration-none"> <h5 class="card-title">Ejemplo de ventanas</h5></a>
                            <a href="WINDOW/window.html" class="text-decoration-none"><p class="card-text">Ejercicio de manejo de ventanas del DOM.</p></a>
                        </div>
                    </div>                   
                    <div class="card card1">
        ...
        <footer class="page-footer font-small blue">
            ...
            <!-- Copyright -->
            <div class="footer-copyright text-center py-3">© 2019 Copyright: Ismael Heras Salvado
